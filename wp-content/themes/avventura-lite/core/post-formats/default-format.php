...
if (!function_exists('avventura_lite_default_format_function')) {

	function avventura_lite_default_format_function() {
	...
	add_action( 'avventura_lite_default_format', 'avventura_lite_default_format_function' );
